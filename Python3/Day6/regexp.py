...
re.search(r'<td>(([01]{0,1}\d{0,1}\d|2[0-4]\d|25[0-5])\.){0,3}([01]{0,1}\d{0,1}\d|2[0-4]\d|25[0-5])</td><td>(?P<port>\d{0,4})</td>','<td>222.182.121.10</td><td>8118</td>')

re.search(r'<td>\w.+?</td><td>(?P<port>\d{0,4})</td>','<td>222.182.121.10</td><td>8118</td>')